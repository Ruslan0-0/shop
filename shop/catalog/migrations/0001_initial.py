    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('In Process', 'In Process'), ('Packed', 'Packed'), ('On the way', 'On the way'), ('Delivered', 'Delivered'), ('Received', 'Received'), ('Refused', 'Refused')], max_length=100)),
                ('delivery_address', models.CharField(blank=True, max_length=250, null=True)),
                ('delivery_methods', models.CharField(choices=[('Courier', 'Courier'), ('Post', 'Post'), ('Self-delivery', 'Self-delivery')], max_length=100)),
